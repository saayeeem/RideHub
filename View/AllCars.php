        ...
        <div class="container">
            ...
            if ($userQuery->num_rows > 0) {
                ...
                while ($row = $userQuery->fetch_assoc()) {
                    echo "<tr><td>" . $row["carname"] . "</td><td>" . $row["carmodel"] . "</td><td>" . $row["sitcount"] . "</td><td>" . $row["fareperh"] . "</td><td>"  .
                        '<a class="btn btn-sm btn-danger" href="DeleteCar.php?car_id=' . $row["car_id"] . '">Delete</a>' . "</td></tr>";
                }
                echo "</table>";
            } else {
                echo "0 results";
