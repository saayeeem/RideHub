      ...
      <section class="pad-70">
          <div class="container">
              ...
              <?php
                ...
                $userQuery = $connection->ShowCarToDriver($conobj, "requested_car","Accepted");
                if ($userQuery->num_rows > 0) {
                    echo "<table><tr><th>Name</th><th>Model</th><th>Sit Count</th><th>Fare/Hour</th><th>Status By Vendor</th><th>Customer ID</th><th>Status by Driver</th><th >Req ID</th><th>Action</th></tr>";
                    ...
                    while ($row = $userQuery->fetch_assoc()) {
                        ...
                        echo ("</td><td>");
                        echo ('<button class="btn btn-sm btn-success">Confirm</button> <button onclick="MyAjaxFunc()" class="btn btn-sm btn-danger">Cancel</button>');
                        echo ("</td></tr>\n");
                    }
                    echo "</table>";
                } else {
      ...
      window.addEventListener('DOMContentLoaded', _e => {
          ...
          buts.forEach(button => {
              button.addEventListener('click', e => {
                  ...
                  xhttp.open("POST", "../Control/acceptCarDriver.php", true);
